  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center h-screen bg-slate-900">
        <div className="max-w-screen-lg mx-auto p-4 bg-slate-400 rounded-lg shadow-lg flex items-center space-x-8">
          ...
          <div className="w-72 h-80">
            ...
            <div className="mb-4 relative">
              <input
                ...
                placeholder="Email"
                className="input-field p-4 mx-auto w-full rounded-xl"
              />
            </div>
            ...
            <button
              onClick={handleLogin}
              className="bg-black hover:bg-gray-900 text-white font-bold py-3 px-6 rounded-full w-full"
            >
              Login
            </button>
